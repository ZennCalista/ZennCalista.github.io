<?php
// Simple test of registration logic
include 'db.php';
...
if ($stmt->execute()) {
    ...
    $student_id = null; // Not provided
    $course = null; // Not provided
    ...
    if ($stmt2->execute()) {
        ...
        echo "<span style='color: green;'>🎉 Complete registration test PASSED</span><br>";
    } else {
