...
/**
 * Get Carousel Images
 * Returns the newest 5 images from the images table for the homepage carousel
 */
...
try {
    ...
    // Query to get the newest 5 images
    // Order by image_id DESC to get the most recent uploads
    $sql = "SELECT image_id, image_desc FROM images ORDER BY image_id DESC LIMIT 5";
